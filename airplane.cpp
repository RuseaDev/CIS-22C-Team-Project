...
Airplane::Airplane(string& aircraft_id,
...
string Airplane::getAirlineName() const
{
    return airline_name;
}

string Airplane::getAircraftType() const
{
    return aircraft_type;
}

int Airplane::getSeatCapacity() const
{
    return seat_capacity;
}

int Airplane::getSeatsOccupied() const
{
